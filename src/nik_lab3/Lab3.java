...
public class Lab3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/nik_lab3/lab.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(minI== maxI && minJ == maxJ-1){
            for(int i = 0;i<jTable1.getColumnCount();i++){
                int temp = matrix[0][i];
                matrix[0][i] = matrix[1][i];
                jTable1.setValueAt(matrix[0][i],0,i);

                matrix[1][i] = temp;
                jTable1.setValueAt(matrix[1][i],1,i);
